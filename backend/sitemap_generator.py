...
STATIC_URLS = [
    ...
    ("/journey/selling",            "0.8", "weekly"),
    ("/journey/buying-and-selling", "0.7", "monthly"),
    ("/journey/condo-strata",       "0.75","monthly"),
    ("/journey/first-time-buyer",   "0.8", "weekly"),
    ("/journey/new-construction",   "0.7", "monthly"),
    ("/journey/acreages",           "0.75","monthly"),
    ("/journey/investment",         "0.6", "monthly"),
    ("/journey/home-ownership",     "0.6", "monthly"),
