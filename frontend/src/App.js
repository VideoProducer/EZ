  ...
  return (<>
    ...
    {open && <div className="doogie-panel" data-testid="doogie-panel">
      ...
      {!consented ? <div style={{padding:"1.25rem",fontFamily:"Inter,sans-serif",fontSize:"0.88rem",lineHeight:1.6,background:"#FFF8E8",flex:1,overflowY:"auto"}} data-testid="doogie-consent">
        ...
        <p style={{margin:"0 0 0.75rem"}}>Doogie is an AI-assisted helper powered by a large language model. Doogie shares <strong>general educational information about BC real estate only</strong> — it is not legal, tax, financial, or property-specific advice, and it is not a substitute for a licensed professional.</p>
