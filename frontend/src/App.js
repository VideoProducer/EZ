  ...
  return (<>
    ...
    {open && <div className="doogie-panel" data-testid="doogie-panel">
      ...
      {!consented ? <div style={{padding:"1.25rem",fontFamily:"Inter,sans-serif",fontSize:"0.88rem",lineHeight:1.6,background:"#FFF8E8",flex:1,overflowY:"auto"}} data-testid="doogie-consent">
        ...
        <p style={{margin:"0 0 0.75rem"}}>Doogie is an AI-assisted chat powered by a large language model. Doogie provides <strong>general information only</strong> — never financial, legal, tax, or property-specific advice.</p>
  ...
  return (<>
    ...
    <section className="hero"><div className="container-x hero-grid">
      <div>
        ...
        <h1><span className="accent" style={{color:"#16A34A",fontFamily:"'Avenir Next','Manrope',sans-serif",fontWeight:600,fontStyle:"normal"}}>Real estate</span><span style={{color:"#000080",fontFamily:"'Avenir Next','Manrope',sans-serif",fontWeight:600}}>,</span><br/><span style={{color:"#000080",fontFamily:"'Avenir Next','Manrope',sans-serif",fontWeight:600}}>made </span><span className="brand-blue" style={{color:"#0EA5E9",fontFamily:"'Helvetica Neue', Helvetica, Arial, sans-serif",fontWeight:700}}>EZ to Find</span><span className="green" style={{color:"#FDB813",fontFamily:"'Helvetica Neue', Helvetica, Arial, sans-serif",fontWeight:700}}>.ca</span></h1>
