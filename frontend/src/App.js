  ...
  return (<section className="section"><div className="container-x" style={{maxWidth:"46rem"}}>
    ...
    {found ? <>
      ...
      {!loading && syn?.synopsis && <>
        ...
        <div style={{fontFamily:"Inter,sans-serif",fontSize:"0.75rem",color:"var(--muted)",marginTop:"0.5rem",fontStyle:"italic"}}>Published by Doug LeMaire, REALTOR® · <strong>AI Disclaimer:</strong> This content was drafted with the assistance of AI. While reviewed for accuracy before publication, information may be incomplete, out-of-date, or contain errors. Verify anything material with a licensed REALTOR® or authoritative source before relying on it.</div>
      </>}
