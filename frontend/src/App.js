  ...
  return (<>
    <section className="hero"><div className="container-x hero-grid">
      <div>
        ...
        <p className="lead" style={{marginTop:"1rem",fontSize:"1rem"}}><strong>Meet Doogie</strong> — EZtoFind.ca's AI-powered research helper, built to explain British Columbia real estate terminology and point you to the right pages on this site. Doogie provides general information only. He does not provide real estate, legal, mortgage, tax, or appraisal advice, does not represent buyers or sellers, and is not a licensee of the British Columbia Financial Services Authority (BCFSA). For advice specific to your situation, Doogie will connect you with Doug LeMaire, REALTOR® — or, for locations outside Doug's practice area, a vetted BC-licensed REALTOR® from our referral network.</p>
...
const GlossaryTerm = () => {
  ...
  return (<section className="section"><div className="container-x" style={{maxWidth:"48rem"}} itemScope itemType="https://schema.org/Article">
    ...
    {(t.faqs && t.faqs.length>0) ? <div className="faq">{t.faqs.map((f,i)=><details key={i}><summary>{f.q}</summary><p>{f.a}</p></details>)}<div style={{fontFamily:"Inter,sans-serif",fontSize:"0.75rem",color:"var(--muted)",marginTop:"1rem",fontStyle:"italic"}}>AI-drafted FAQs, reviewed and approved by Doug LeMaire, REALTOR®</div></div>
