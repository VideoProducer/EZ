  ...
  return (<>
    <section className="hero"><div className="container-x hero-grid">
      <div>
        ...
        <h1><span className="accent" style={{color:"#16A34A",fontFamily:"Montserrat,sans-serif",fontWeight:600,fontStyle:"normal"}}>Real estate</span><span style={{color:"#000080",fontFamily:"Montserrat,sans-serif",fontWeight:600}}>,</span><br/><span style={{color:"#000080",fontFamily:"Montserrat,sans-serif",fontWeight:600}}>made </span><span className="brand-blue" style={{color:"#0EA5E9",fontFamily:"Montserrat,sans-serif",fontWeight:700}}>EZ to Find</span><span className="green" style={{color:"#FDB813",fontFamily:"Montserrat,sans-serif",fontWeight:700}}>.ca</span></h1>
