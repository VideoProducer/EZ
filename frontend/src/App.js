  ...
  return (<>
    <section className="hero"><div className="container-x hero-grid">
      <div>
        ...
        <h1><span className="accent" style={{color:"#16A34A"}}>Real estate</span>,<br/>made <span className="brand-blue" style={{color:"#2E9E4F"}}>EZ to Find</span><span className="green" style={{color:"#FDB813"}}>.ca</span></h1>
