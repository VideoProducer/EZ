  ...
  return (<>
    <section className="hero"><div className="container-x hero-grid">
      ...
      <div style={{textAlign:"center",overflow:"visible"}}>
        <img src={DOOGIE_MAGNIFY} alt="Doogie mascot" style={{width:"100%",maxWidth:"none",transform:"scale(2.8)",transformOrigin:"center center",filter:"drop-shadow(0 20px 40px rgba(15,42,91,0.2))"}}/>
      </div>
    </div></section>
