...
const CORRIDORS = [
  { slug: "west-van-estates",       name: "West Vancouver Estates",         median: 8250000, count: 231, propertyType: "House", hero: "https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=800", editorial: "British Properties, Point Grey, and Caulfeild — heritage estates on view lots, waterfront moorage, and coach-house guest quarters.", cities: ["West Vancouver"] },
  { slug: "vancouver-luxury-detached", name: "Vancouver Luxury Detached",     median: 4900000, count: 519, propertyType: "House", hero: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800", editorial: "Point Grey, Shaughnessy, Kerrisdale, and Kitsilano — heritage west-side estates, architectural rebuilds, and gated pied-à-terre residences on Vancouver's most storied streets.", cities: ["Vancouver"] },
